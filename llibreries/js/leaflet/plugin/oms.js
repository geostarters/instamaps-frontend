        ...
        null != this.L && (this.OverlappingMarkerSpiderfier = function() {
            ...
            d.spiderListener = function(c) {
                ...
                for (k = l.length; h < k; h++)
                    b = l[h],
                    this.map.hasLayer(b) && (a = this.map.latLngToLayerPoint(b.getLatLng()),
                    this.ptDistanceSq(a, e) < d ? g.push({
                        marker: b,
                        markerPt: a
                    }) : f.push(b));
            ...
            d.unspiderfy = function(c) {
                ...
                for (k = h.length; f < k; f++)
                    b = h[f],
                    null != b._omsData ? (this.map.removeLayer(b._omsData.leg),
                    b !== c && b.setLatLng(b._omsData.usualPosition),
                    (b.setZIndexOffset ? b.setZIndexOffset(0) : b),
                    a = b._omsData.highlightListeners,
                    null != a && (b.removeEventListener("mouseover", a.highlight),
