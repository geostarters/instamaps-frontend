// Twitter plugin for Leaflet
// https://github.com/shurshur/Leaflet.Twitter
...
L.Twitter = L.FeatureGroup.extend({
	...
	_update: function() {
		...
		*/
var url='https://api.twitter.com/1.1/search/tweets.json?q=mapes&geocode='+centre.lat+','+centre.lng+',5km&result_type=mixed&count=100&callback='+cbid;
		
		  
		  /*
		  
		  https://api.twitter.com/1.1/search/tweets.json?q=mapes&geocode='+centre.lat+','+centre.lng+',5km&result_type=mixed&count=100&callback='+cbid
