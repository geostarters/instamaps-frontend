    ...
    if(typeof url('?businessid') == "string"){
		...
		getCacheMapByBusinessId(data).then(function(results){
			if (results.status == "ERROR"){
				...
				var uidUrl = url('?uid');
				if ( url('?mapacolaboratiu') && !Cookies.get('uid')) {
					Cookies.set('collaboratebid', url('?businessid'));
					Cookies.set('collaborateuid', uidUrl);
					window.location.href = paramUrl.loginPage;
				}
				else if (url('?mapacolaboratiu') && uidUrl!=Cookies.get('uid')) {
					Cookies.remove('uid');
					Cookies.set('collaboratebid', url('?businessid'));
					Cookies.set('collaborateuid', uidUrl);
					window.location.href = paramUrl.loginPage;
