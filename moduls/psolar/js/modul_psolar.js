...
*/
				...
				var colorFF="#ff0000";	
				if(maxim==3){ colorFF="#3B1B00"; //pbre #3B1B00
				}
				else if(maxim==1){colorFF="#BB6910";//regular #BB6910
				}	
				else if(maxim==2){colorFF="#FFB002";//adequat #FFB002
				}	
				else if(maxim==0){colorFF="#FFFF00";//optim #FFFF00
				}	
				
				geojson.features[i].properties.style={ weight: 2, color: "#F200FF",opacity: 1,fillColor: colorFF ,fillOpacity: 1 };
...
function addColorParcelaTS(geojson,val1,val2,val3){
				...
				var colorFF="#ff0000";	
				if(maxim==2){ colorFF="#3B1B00"; //pbre #3B1B00
				}
				
				else if(maxim==1){colorFF="#FFB002";//adequat #FFB002
				}	
				else if(maxim==0){colorFF="#FFFF00";//optim #FFFF00
				}	
