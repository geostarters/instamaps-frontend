...
var CatPol= [ [ 0.8349609375, 42.751045990383531 ], [ 0.7855224609375, 41.902277040963696 ], [ 0.32958984375, 40.759740592073918 ], [ 0.560302734375, 40.638967343817228 ], [ 1.0107421875, 41.137296061122733 ], [ 2.08740234375, 41.405655838081692 ], [ 3.065185546875, 41.926803206487911 ], [ 3.076171875, 42.370720143531955 ], [ 1.878662109375, 42.326062444562012 ], [ 0.8349609375, 42.751045990383531 ] ] ;
...
var URL_HISTORICOrto=urlServerTiles+'/mapcache/tms/1.0.0/orto55_3857@GMTOT/{z}/{x}/{y}.png';
var URL_HISTORICOrto46=urlServerTiles+'/mapcache/tms/1.0.0/orto46_3857@GMTOT/{z}/{x}/{y}.png';
var URL_ALCADAMAP=urlServerTiles+'/mapcache/tms/1.0.0/h_ombra3857@GMTOT/{z}/{x}/{y}.png';
...
L.IM_Map = L.Map.extend({
	...
	initialize: function(id,options) {
		...
		}else if(this.options.typeMap==FONS_FONS_DIVADMIN){this.divadminMap();
		}else{
	...
	getLGActiveMap:function(){
		...
		}else if(this.options.typeMap==FONS_FONS_DIVADMIN){return _divadminMap;
		}else{
		return _topoLayers;
		}		
	...
	gestionaFons:function(layerAdd){		
		...
		//var _topoLayersGeo=null,TOPO_GEO_MQ_L15_18,TOPO_GEO_ICC_L8_12,TOPO_GEO_ICC_L8_17;	
			...
			this.attributionControl.setPrefix(ICGC_HISTOOrto46 +" ZL:"+this.getZoom());		
	...
	topoMapGeo: function (){	
		...
		TOPO_GEO_MQ_L15_18 = new L.TileLayer(URL_MQ,{   	   
			minZoom: 15,
			maxZoom:18,
...
if(print){
	...
	naturalMap: function (){	
		...
		TOPO_GEO_MQ_L15_18 = new L.TileLayer(URL_MQ_NATURAL,{   	   
			minZoom: 12,
			maxZoom:18,
		...
		TOPO_GEO_ICC_L8_17 = new L.TileLayer(URL_TOPOICC_GEO_NATURAL,{  	    
			tms:true,
			continuousWorld: true,
			worldCopyJump: false,
			minZoom: 8,
	...
	hibridMap: function (print){
		...
		HIBRID_MQ_L0_18 = new L.TileLayer(URL_ESRI,{   	   
			minZoom: 0,
			maxZoom:18,
			subdomains:subDomains
		}).addTo(_hibridLayers);
		...
		HIBRID_ICGC_L13_18 = new L.TileLayer(URL_ORTOICC,{  	    
			tms:false,
			minZoom: 13,
			maxZoom: 18,	                                                        			
			continuousWorld: true,
