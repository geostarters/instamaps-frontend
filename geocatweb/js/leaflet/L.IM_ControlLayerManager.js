...
/*
 * Based on https://github.com/davicustodio/Leaflet.StyledLayerControl
 * 
 * 
 * 
 */
...
L.Control.ControlLayerManager = L.Control.Layers.extend({
		options : {
			collapsed : true,
			position : 'topright',
			autoZIndex : true
		...
		_addItem : function (obj) {
			...
			if( obj.layer.ControlLayerManager && obj.layer.ControlLayerManager.removable ){
...
L.Control.controlLayerManager = function (baseLayers, overlays, options) {
	return new L.Control.ControlLayerManager(baseLayers, overlays, options);
};
