...
L.Control.LayerManagerControl = L.Control.Layers.extend({
		options : {
			collapsed : true,
			position : 'topright',
			autoZIndex : true
		...
		_addItem : function (obj) {
			...
			if( obj.layer.LayerManagerControl && obj.layer.LayerManagerControl.removable ){
...
L.Control.LayerManagerControl = function (baseLayers, overlays, options) {
	return new L.Control.LayerManagerControl(baseLayers, overlays, options);
};
