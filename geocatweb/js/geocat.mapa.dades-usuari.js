...
function addHtmlModalDadesUsuari(){
	...
	'					<h4 id="modal-title-teves-dades" class="modal-title"><span lang="ca">Accedeix a les teves dades</span><span><a class="faqs_link" href="http://betaportal.icgc.cat/wordpress/faq-dinstamaps/" target="_blank"><i class="fa fa-question-circle-o fa-lg fa-fw"></i></a></span></h4>'+
	'				</div>'+
