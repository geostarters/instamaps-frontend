var IM_DadesOficials = function (options) {
	...
	this.generaOpcionsHTMLDadesOficials = function () {
		...
		_htmlDadesOficials.push('<li style="text-align: center"><a class="label-dof" href="#" id="opt_id_pcc">' + window.lang.translate("Pla Cartogràfic de Catalunya-INSPIRE") + '</a></li>');
		_htmlDadesOficials.push('<li style="text-align: center"><a class="label-dof" href="#" id="opt_id_inspi">' + window.lang.translate("Geoportal INSPIRE") + '</a></li>');
		...
		//_htmlDadesOficials.push('<span class="label label-font">' + window.lang.translate("Font") + ': <a target="_blank" href="http://inspire-geoportal.ec.europa.eu/discovery/">INSPIRE Catalog</a></span>');
