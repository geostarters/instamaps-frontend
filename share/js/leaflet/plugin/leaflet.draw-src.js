...
L.Draw.Marker = L.Draw.Feature.extend({
	...
	_onMouseMove: function (e) {
		...
		if (!this._marker) {
			...
			//this._marker.on('dragstart', function (){console.info('1');}, this);
			//this._marker.on('drag', function (){console.info('2');}, this);
			//this._marker.on('dragend', function (){console.info('e');}, this);
			//this._mouseMarker.on('drag', function (){console.info('3');}, this);
			//this._mouseMarker.on('dragend', function (){console.info('3');}, this);
			//this._marker.on('mouseout', function (){console.info('hola');}, this);
			this._map
				.on('click', this._onClick, this)
